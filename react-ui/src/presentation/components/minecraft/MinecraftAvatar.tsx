...
export const MinecraftAvatar = memo(function MinecraftAvatar({
  ...
  const transitionClass = transitionName ? '[view-transition-name:player-avatar]' : '';
  ...
  if (!hasValidSkin || !avatarUrl) {
    return (
      <div
        className={`bg-primary flex items-center justify-center text-white font-black rounded-lg ${transitionClass} ${className}`}
