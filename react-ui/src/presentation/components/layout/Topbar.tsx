  ...
  return (
    <header className="h-20 flex items-center justify-between px-8 z-10 relative shrink-0 border-b border-black/5">
      ...
      <div className="flex items-center gap-6">
        ...
        {/* Notifications */}
        <button className="w-10 h-10 bg-surfaceLight border border-black/5 flex items-center justify-center text-textMuted hover:text-textMain hover:border-primary/50 transition-colors mc-cutout-small">
          <FiBell />
        </button>
