      ...
      <div className="grid grid-cols-12 gap-8">
            ...
            <div className="space-y-6 mt-8">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4">
                  ...
                  />
                  <span className="w-24 px-3 py-2 bg-surfaceLight border border-white/5 text-center font-mono text-primary text-sm mc-cutout-small">
                    {memory} MB
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-2 pt-4 border-t border-white/5">
                ...
                <div className="grid grid-cols-5 gap-4 mt-2">
                  {AVAILABLE_LOGOS.map((item) => (
                    <div 
                      key={item.id} 
                      className={`cursor-pointer border-2 p-2 flex flex-col items-center gap-2 mc-cutout-small transition-all ${logo === item.id ? 'border-primary bg-primary/10' : 'border-transparent bg-surfaceLight hover:bg-white/5'}`}
              ...
              <div className="space-y-2 pt-4 border-t border-white/5">
                ...
                <div className="flex items-center gap-4">
                  <Button onClick={handleClearCache} className="bg-surfaceLight border border-white/10 text-textMain hover:bg-white/5 transition-colors px-6 py-3 font-bold uppercase tracking-widest text-xs" icon={<FiTrash2 />}>
        ...
        <div className="col-span-5 flex flex-col gap-8">
          <Card>
            ...
            <div className="bg-surfaceLight/30 p-4 border border-white/5 space-y-2 mc-cutout-small">
          ...
          <Card className="flex-1">
              ...
              <div className="grid grid-cols-2 gap-4 mt-6">
                <div className="bg-surfaceLight/20 p-3 border border-white/5 mc-cutout-small">
                ...
                <div className="bg-surfaceLight/20 p-3 border border-white/5 mc-cutout-small col-span-2">
