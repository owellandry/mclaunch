    ...
    <div className="flex flex-col gap-8 pb-8">
      <Card className="border-primary/20 shadow-[0_0_30px_var(--color-primary-shadow)]">
        ...
        <div className="grid grid-cols-3 gap-6 mt-8">
          {SERVERS.map((srv) => (
            <div key={srv.name} className="bg-surfaceLight/40 border border-white/5 p-6 hover:bg-surfaceLight/80 hover:border-primary/30 transition-all mc-cutout">
      ...
      <div className="grid grid-cols-2 gap-8">
        <Card>
          <SectionTitle
            ...
            icon={<FiServer />}
          />
          <div className="mt-6 bg-surfaceLight/30 border border-white/5 h-32 flex flex-col items-center justify-center text-textMuted uppercase tracking-widest text-sm font-bold mc-cutout border-dashed">
